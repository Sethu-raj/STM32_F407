...
// It will send hello sethu over mosi lin e
...
void SPI2_GPIOInits(void)
{
	...
	// MISO   - we can disable this pin not using
	SPIPins.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NO_14;
	SPIPins.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_PIN_PU;
	GPIO_Init(&SPIPins);

	// NSS  - we can disable this pin not using
	NSSpin.pGPIOx = GPIOB;
...
int main(void)
{
	...
	//this function is used to initalize gpio pins behave as SPI
	SPI2_GPIOInits();

	//this function is used to initailze spi2 peripheral parameters.
	SPI2_Init();
